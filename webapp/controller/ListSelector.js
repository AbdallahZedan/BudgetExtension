sap.ui.define([
		...
		"use strict";
		return BaseObject.extend("ExtensionApproval.ExtensionApproval.controller.ListSelector", {
			 ...
			 * @class
			 * @public
			 * @alias ExtensionApproval.ExtensionApproval.controller.ListSelector
			 */
			 ...
			 * @public
			 */
			setBoundMasterList : function (oList, inboxModel) {
				this._oList = oList;
			 ...
			 * @return {ExtensionApproval.ExtensionApproval.model.ListSelector} the list selector object for method chaining
			 * @public
			 */
