sap.ui.define([
	...
	function getFrameUrl (sHash, sUrlParameters) {
		var sUrl = jQuery.sap.getResourcePath("ExtensionApproval/ExtensionApproval/app", ".html");
		sHash = sHash || "";
	...
	return Opa5.extend("ExtensionApproval.ExtensionApproval.test.integration.pages.Common", {
		...
		getMockServer : function () {
			return new Promise(function (success) {
				Opa5.getWindow().sap.ui.require(["ExtensionApproval/ExtensionApproval/localService/mockserver"], function (mockserver) {
