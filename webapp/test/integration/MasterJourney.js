...
sap.ui.define([
	...
	opaTest("MasterList Filtering on Amount less than 100", function(Given, When, Then) {

		// Action
		When.onTheMasterPage.iOpenViewSettingsDialog().
			and.iSelectListItemInViewSettingsDialog("<Amount>").
			and.iSelectListItemInViewSettingsDialog("<100 <Curr>").
	...
	opaTest("MasterList Filtering on Amount more than 100", function(Given, When, Then) {
		// Action
		When.onTheMasterPage.iOpenViewSettingsDialog().
			and.iSelectListItemInViewSettingsDialog(">100 <Curr>").
			and.iPressOKInViewSelectionDialog();
